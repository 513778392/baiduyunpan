 ...
 */
public class LiShiLineWrapLayout extends ViewGroup {
    ...
    public LiShiLineWrapLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        this.context = context;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.linewarplayout);
        magin = a.getInt(R.styleable.linewarplayout_magin, 10);
        bgId = a.getResourceId(R.styleable.linewarplayout_itemBg, R.mipmap.lishisousuo);
    }
    ...
    public void addView(String s){
        ...
        textView.setTextColor(context.getResources().getColor(R.color.zitiyanse3));
    ...
    public void setData(List<String> data)
    {
        ...
        for(int i = 0;i<data.size();i++)
        {
          ...
          /*  LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
            ...
            if((boolean) SharedPreferencesUtils.getBean(App.app, App.BAITIAN)) {
                textView.setTextColor(context.getResources().getColor(R.color.zitiyanse6));
                textView.setBackgroundResource(R.drawable.paihang2);
            }else {
                textView.setTextColor(context.getResources().getColor(R.color.white));
                textView.setBackgroundResource(R.drawable.paihang);
            }
            textView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtil.v(sizeWidth+"=="+sizeHeight+"=="+modeWidth+"=="+modeHeight);
        int mWidth = 0;
        int mHeight = 0;
        ...
        LogUtil.v(sizeWidth+"=="+sizeHeight+"=="+mWidth+"=="+mHeight);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        {
            int hang = 0;
            if(MainActivity.screenWidth>900){
                hang = 5;
            }else {
                hang = 4;
            }
